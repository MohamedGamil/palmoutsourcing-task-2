...
.PHONY: up up-build down ps logs install migrate fresh seed tinker swagger api-composer api-artisan api-make api-sh web-install web-sh reset-db clean prune
